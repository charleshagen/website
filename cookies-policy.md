...
such as a unique identifier, website’s domain name, and some digits and numbers. Nightphotons 
utilizes cookies for [Google Analytics](https://developers.google.com/analytics) to track site 
traffic and search engine performance. 

### What types of cookies do we use?
Analytical cookies enable us and third-party services to collect aggregated data for statistical
...
### Contacting us
If you have any questions about this policy or our use of cookies, please [contact us](/contact.md).

<!-- derived from https://www.websitepolicies.com/blog/sample-cookie-policy-template -->